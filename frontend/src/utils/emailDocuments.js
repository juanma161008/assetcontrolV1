...
export function buildMaintenanceOrderHtml({
  ...
  // La tarjeta del interventor refleja el estado real de la orden: aprobada (con firma),
  // rechazada (con comentario) o pendiente, en vez de mostrar siempre "Pendiente".
